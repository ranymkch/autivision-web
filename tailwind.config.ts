  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        "display-lg": ["clamp(2rem, 4.2vw, 3.75rem)", { lineHeight: "1.05", letterSpacing: "-0.025em" }],
        "display-md": ["clamp(1.5rem, 2.6vw, 2.5rem)", { lineHeight: "1.15", letterSpacing: "-0.02em" }],
      },
      backgroundImage: {
        ...
        "radial-fade": "radial-gradient(ellipse 60% 50% at 50% -10%, hsl(var(--primary) / 0.18), transparent 60%)",
      },
